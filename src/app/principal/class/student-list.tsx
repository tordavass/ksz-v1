...
export default function PrincipalStudentList({ students }: { students: Student[] }) {
                        ...
                        {sortedStudents.map((student) => {
                            ...
                            return (
                                <tr key={student.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-center">
                                        <Link href={`/principal/student/${student.id}`} className="text-[var(--kreta-blue)] hover:underline text-sm font-medium">
                                            Részletek
                                        </Link>
                                    </td>
                                </tr>
